...
module.exports = {
    pageEntrega_finalizada: (req, res) => {
        ...
        (async function () {
          ...
          //  let html = await DBModel.gethtml();
            ...
            page = './includes/cadastros/inc_entrega_finalizada';

         
            db.query("call sp_consulta_pedidos_entregue(?,?,?)", [req.session.unidade,req.session.id_perfil,req.session.cod_login], 
            function (err, result) {
