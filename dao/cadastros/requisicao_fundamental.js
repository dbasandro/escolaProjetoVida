...
module.exports = {
    pageRequisicao_fundamental: (req, res) => {
        ...
        (async function () {
            ...
            page = './includes/cadastros/inc_requisicao_fundamental';
    ...
    addRequisicao_fundamental: (req, res) => {
...
console.log(req.body)
                ...
                id_disciplina = 41
                    ...
                    db.query(insertpedito, (err, resultadoinsertpedito, fields) => {
                        ...
                        console.log(resultadoinsertpedito)
                            ...
                            status_Crud = 'nao';
                            res.redirect('/requisicao_fundamental');
                        } else {
                  ...
                  db.query(sql, [pedido], function (error, results40, fields) {                      if (error) console.log(error)
                     ...
                     queryResults1 = results40[0]
                      ...
                      var emailASerEnviado = {
                        ...
                        to: 'almoxarifado.fundamental@escolapv.com.br',
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    addProduto_fundamental: (req, res) => {
...
conn.query(sql, [values], function(err) {
    ...
    editRequisicao_fundamental: (req, res) => {
    ...
    delRequisicao_fundamental: (req, res) => {
